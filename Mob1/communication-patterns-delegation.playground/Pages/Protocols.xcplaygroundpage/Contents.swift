...
let Elliel = Hero(health: 10000, strength: 100000, aim: 1000)

let ch = Elliel as Character
//ch.strength = 1000
var Coco = Henchman(health: 5000, aim: 10)
Coco.aim = 500
Coco.strength

var pop = Coco as Character
pop.aim = 500


let stormtropper = Henchman(health: 1000, aim: -200)
...
/*:
 ...
 We can constrain protocols to classes where we are only going to use this protocol on classes
...
class Car: Vehicle {
    ...
    let doors: Int
    let modelProps: String
    
    func vroom() {
        "Print vroom vroom"
    }
    
    init(maxSpeed: Int, numberOfWheels: Int, doors: Int, modelProps: String) {
...
let nestedArray: [[Int]] = [[2,5,9], [0, 4, 2], [6, 8, 3]]
