...
func doesApply(a: Int, b: Int, operation: (Int, Int) -> Bool) -> Bool {
    return operation(a, b)
}

func areBothDivisibleByThree(num1: Int, num2: Int) -> Bool {
...
doesApply(a: 47685, b: 344832, operation: areBothDivisibleByThree)

doesApply(a: 85436, b: 53896, operation: { (a,b) -> Bool in
...
doesApply(a: 85436, b: 53893) { (a, b) -> Bool in
    if a % 3 == 0 && b % 3 == 0 {
        return true
    } else {
        return false
...
doesApply(a: 85436, b: 53893) { (a, b) -> Bool in
    let sum1 = sumOfDigits(a: a)
    let sum2 = sumOfDigits(a: b)
    if sum1 == sum2 {
        return true
    } else {
        return false
...
func manipulateString(string1: String, string2: String, operate: (String, String) -> String?) -> String? {
    return operate(string1, string2)
}

func cocatenateSmallStrings(string1: String, string2: String) -> String? {
...
manipulateString(string1: "abc", string2: "def", operate: cocatenateSmallStrings(string1:string2:))

manipulateString(string1: "abcdef", string2: "ghijkl", operate: cocatenateSmallStrings(string1:string2:))
